...
// CONFIG
$level_limit = 10; // minimum 1 character with 30 lvl on account to post
        ...
        if(canPost($account_logged) || $group_id_of_acc_logged >= $group_not_blocked)
        {
            ...
            if(isset($thread['id']))
            {
                ...
                if(!$saved)
                {
                    ...
                    <tr bgcolor="'.$config['site']['darkborder'].'"><td valign="top"><b>Message:</b></td><td><textarea rows="10" cols="60" name="text">'.htmlspecialchars($text).'</textarea><br />(Max. 15,000 letters)</td></tr>
