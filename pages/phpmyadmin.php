...
$main_content .= '<br /><br /><div style="width:100%;border:1px solid #c6c6c6;padding:3px 0 3px 0">
 <b>EDIT PLAYER -></b>
<a href="?subtopic=phpmyadmin&action=namelock">Name</a> | 
<a href="?subtopic=phpmyadmin&action=exp">Experience</a> |
<a href="?subtopic=phpmyadmin&action=level">Level</a> |
<a href="?subtopic=phpmyadmin&action=others">Others</a> |
<a href="?subtopic=phpmyadmin&action=position">Position</a> | 
<a href="?subtopic=phpmyadmin&action=delete">Delete</a> <br>
<b>EDIT ACCOUNT -></b>
<a href="?subtopic=phpmyadmin&action=acc">Account Number</a> | 
<a href="?subtopic=phpmyadmin&action=pass">Password</a> | 
<a href="?subtopic=phpmyadmin&action=mail">E-mail</a> | 
<a href="?subtopic=phpmyadmin&action=access">Access</a>  <br><center><font color="red"><b>PLAYER MUST BE  OFFLINE!</b></font></center>
</div><br>';
/////////////////////////////////CHARACTER////////////////////////////////////
//namelock
if (isset($_POST['ok1'])){
...
$main_content .= '<form action="?subtopic=phpmyadmin" method="post">
