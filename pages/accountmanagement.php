...
else
{
	...
	if($action == "")
	{
		if($account_logged->getCustomField('premdays') > 0)
			$account_statusOver = '
				<span class="green">
					<span class="BigBoldText"><b><font color="green">Premium Account, '. $account_logged->getPremDays() .' days left</font></b></span>
				</span>';
		else
			$account_statusOver = '
				<span class="red">
					<span class="BigBoldText"><b><font color="red">Free Account</font></b></span>
				</span>';
																	...
																	foreach($account_players as $account_player)
																		{
																			...
																			<tr id="CharacterRow_'.$player_number_counter.'" 
																				...
																				if(is_int($player_number_counter / 2))
																					$main_content .= 'background-color: #3a3738;">';
																				else
																					$main_content .= 'background-color: #3a3738;">';
																				...
																				<td id="CharacterCell3_'.$player_number_counter.'">';
																					if(!$account_player->isOnline())
																						$main_content .= '<font color="red"><b>offline</b></font>';
																					else
																						$main_content .= '<font color="green"><b>online</b></font>';
																					if($account_player->isDeleted())
																						{
									...
									<tbody>
										<tr>
											<td>
												...
												<p>Click <a href="?subtopic=shopadmin">here</a> to go your new <strong>Shop Admin</strong></p>
											</td>
										</tr>
										<tr></tr>
									</tbody>
											...
											<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%" >
														<tr style="background-color:#3a3738;" >
														...
														<tr>
															<td>
																<table style="width:100%;">
																	...
																	<tr>
																		<td class="LabelV" >Contact Email:</td>
