...
######### C A I X A ########
#############################
#! Informações do pagamento com PIX !#
...
Aqui estão os passos que você precisa fazer: 
1. Escolha o valor desejado. 
2. Acesse o seu aplicativo do Banco, e faça um PIX para a chave e-mail (@gmail.com).
3. Faça o deposito. 
